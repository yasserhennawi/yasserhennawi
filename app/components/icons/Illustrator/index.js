...
export default function Illustrator({ onClick, fill, ...props }) {
  return (
      <svg
        ...
        viewBox="0 0 240 234"
      >
        <rect x="10" y="10" style={{fillRule:'evenodd',clipRule:'evenodd',fill:'#261300',}} width="220" height="213.999"/>
        <path style={{fillRule:'evenodd',clipRule:'evenodd',fill:'#FF7C00'}} d="M0,0V234h240.001V0H0z M10,10h220.001V224H10V10z"/>
        <path style={{fillRule:'evenodd',clipRule:'evenodd',fill:'#FF7C00'}} d="M83.252,132.501l-7.92,29.982
