...
const StyledSVG = styled.svg`
   ...
   stroke-width: 1px;
`
export default function Css({onClick, ...props}) {
  return (
    <StyledSVG onClick={onClick} width="100%" height="100%" viewBox="85.5 210.272 437.29 491.728" enable-background="new 85.5 210.272 437.29 491.728">
